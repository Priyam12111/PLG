    ...
    while i < 100:
        if len(os.listdir('D:\Plag\plagdir')) != 0:
            try:
                ...
                # /html/body/div[2]/div[4]/div[2]/div[2]/div[4]/table/tbody/tr[3]/td[5]/a[1]
                # /html/body/div[2]/div[4]/div[2]/div[2]/div[4]/table/tbody/tr[4]/td[5]/a[1]
                try:
                    Alert(driver).accept()
                except Exception:
                    pass
        ...
        while i < int(getVars(3))+2:
            try:
                percentage = driver.find_element(
                    by=By.XPATH, value=f'/html/body/div[2]/div[4]/div[2]/div[2]/div[4]/table/tbody/tr[{i}]/td[4]/span/a/span[1]').get_attribute('innerText')
                slot = driver.find_element(
                    by=By.XPATH, value=f'/html/body/div[2]/div[4]/div[2]/div[2]/div[4]/table/tbody/tr[{i}]/td[1]/div').get_attribute('innerText').capitalize()
                num = j
                for x in getCsv(num):
                    if x == "%":
    ...
    for i in range(2, 100):
        try:
            kml = driver.find_element(
                by=By.XPATH, value=f'/html/body/div[2]/div[4]/div[2]/div[2]/div[4]/table/tbody/tr[{i}]/td[5]/span/ul/li[1]/script').get_attribute('innerHTML')
            it = (kml.find('fn'))
            ot = kml.find('type')
            fn = kml[it+5:ot-3]
            try:
            ...
            file_slot = driver.find_element(
                by=By.XPATH, value=f'/html/body/div[2]/div[4]/div[2]/div[2]/div[4]/table/tbody/tr[{i}]/td[1]').get_attribute('innerText')
